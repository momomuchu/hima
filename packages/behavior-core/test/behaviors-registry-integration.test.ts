 ...
 *
 * Ported from packages/core/test/behaviors-registry-integration.test.ts
 * Adapted imports to @hima/behavior-core local paths.
 */
...
import { getAllBehaviors, getBehaviorsForGate } from "../src/behavior-registry.js";
